...
USkeleton* UEFModelFactory::CreateSkeleton(FString Name, UObject* Parent, EObjectFlags Flags, FSkeletonData& Data, FReferenceSkeleton& RefSkeleton)
{
	...
	{
		FName SourceBoneName(VirtualBone.SourceBoneName.c_str());
		FName TargetBoneName(VirtualBone.TargetBoneName.c_str());
		FName VirtualBoneName(VirtualBone.VirtualBoneName.c_str());
